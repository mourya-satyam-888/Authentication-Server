...
public final class CreateUserServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.authentication.CreateUserService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.authentication.CreateUserRequest,
      com.authentication.CreateUserResponse> getCreateUserMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "createUser",
      requestType = com.authentication.CreateUserRequest.class,
      responseType = com.authentication.CreateUserResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.authentication.CreateUserRequest,
      com.authentication.CreateUserResponse> getCreateUserMethod() {
    io.grpc.MethodDescriptor<com.authentication.CreateUserRequest, com.authentication.CreateUserResponse> getCreateUserMethod;
      ...
      synchronized (CreateUserServiceGrpc.class) {
        if ((getCreateUserMethod = CreateUserServiceGrpc.getCreateUserMethod) == null) {
          CreateUserServiceGrpc.getCreateUserMethod = getCreateUserMethod =
              io.grpc.MethodDescriptor.<com.authentication.CreateUserRequest, com.authentication.CreateUserResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "createUser"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.authentication.CreateUserRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.authentication.CreateUserResponse.getDefaultInstance()))
  ...
  public static abstract class CreateUserServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void createUser(com.authentication.CreateUserRequest request,
        io.grpc.stub.StreamObserver<com.authentication.CreateUserResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.authentication.CreateUserRequest,
                com.authentication.CreateUserResponse>(
  ...
  public static final class CreateUserServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<CreateUserServiceBlockingStub> {
    ...
    /**
     */
    public com.authentication.CreateUserResponse createUser(com.authentication.CreateUserRequest request) {
  ...
  public static final class CreateUserServiceFutureStub extends io.grpc.stub.AbstractFutureStub<CreateUserServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.authentication.CreateUserResponse> createUser(
        com.authentication.CreateUserRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_USER:
          serviceImpl.createUser((com.authentication.CreateUserRequest) request,
              (io.grpc.stub.StreamObserver<com.authentication.CreateUserResponse>) responseObserver);
          break;
        default:
