...
public final class AuthenticationServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.authentication.AuthenticationService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.authentication.AuthenticationRequest,
      com.authentication.AuthenticationResponse> getAuthenticateUserMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "authenticateUser",
      requestType = com.authentication.AuthenticationRequest.class,
      responseType = com.authentication.AuthenticationResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.authentication.AuthenticationRequest,
      com.authentication.AuthenticationResponse> getAuthenticateUserMethod() {
    io.grpc.MethodDescriptor<com.authentication.AuthenticationRequest, com.authentication.AuthenticationResponse> getAuthenticateUserMethod;
      ...
      synchronized (AuthenticationServiceGrpc.class) {
        if ((getAuthenticateUserMethod = AuthenticationServiceGrpc.getAuthenticateUserMethod) == null) {
          AuthenticationServiceGrpc.getAuthenticateUserMethod = getAuthenticateUserMethod =
              io.grpc.MethodDescriptor.<com.authentication.AuthenticationRequest, com.authentication.AuthenticationResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "authenticateUser"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.authentication.AuthenticationRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.authentication.AuthenticationResponse.getDefaultInstance()))
  ...
  public static abstract class AuthenticationServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void authenticateUser(com.authentication.AuthenticationRequest request,
        io.grpc.stub.StreamObserver<com.authentication.AuthenticationResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.authentication.AuthenticationRequest,
                com.authentication.AuthenticationResponse>(
  ...
  public static final class AuthenticationServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AuthenticationServiceBlockingStub> {
    ...
    /**
     */
    public com.authentication.AuthenticationResponse authenticateUser(com.authentication.AuthenticationRequest request) {
  ...
  public static final class AuthenticationServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AuthenticationServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.authentication.AuthenticationResponse> authenticateUser(
        com.authentication.AuthenticationRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_AUTHENTICATE_USER:
          serviceImpl.authenticateUser((com.authentication.AuthenticationRequest) request,
              (io.grpc.stub.StreamObserver<com.authentication.AuthenticationResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class AuthenticationServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.authentication.Schema.getDescriptor();
    }
